...
export const updateStats = (
  ...
  const totalExpenses =
    newEmployees * employeeWage + (s.dailyExpenses + (c.dailyExpenses ?? 0));
      ...
      customerSatisfaction: clampAndRound(
        s.customerSatisfaction +
          (c.customerSatisfaction ?? 0) *
            (c.customerSatisfaction && c.customerSatisfaction > 0
              ? satM
              : 2 - satM),
      ),
    },
