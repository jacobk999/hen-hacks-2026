export interface PlayBigProps {
  variant: "contrast" | "solid" | "stroke";
  className?: string;
}

export function PlayBig({ variant, className }: PlayBigProps) {
  switch (variant) {
    case "contrast":
      return (
        <svg
